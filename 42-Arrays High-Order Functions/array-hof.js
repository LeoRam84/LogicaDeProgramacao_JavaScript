...
//   nomes.push(personagem.nome)  // Ou nomes.push(personagens[i].nome)
// }
...
// for (let i = 0; i < personagens.length; i++) {
//   const personagem = personagens[i]
//   if (personagem.raca === "Orc") { // Ou if(personagens[i].raca === "Orc")
...
//   return a.nivel - b.nivel // Ou return b.nivel - a.nivel  para ordenar em ordem decrescente
// })
